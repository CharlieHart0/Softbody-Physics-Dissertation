...
namespace NCL::Win32Code {
	...
	typedef MessageFeedback(*ExInputFunc)(void*); 
	// imgui code end
	...
	public:
		...
		void ImGuiMsgFunc(ExInputFunc func) { exInputFunc = func; }// imgui message func
	protected:
		...
		ExInputFunc exInputFunc = nullptr; // imgui message func
	};
}
#endif //_WIN32